...
const constants = {
  ...
  MIN_AMOUNT_OF_ALIVE_NEIGHBOURS: 0,
...
class Cell {
  constructor() {
    this.lifeStatus = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
    this.lifeStatusOnLastGeneration = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
    this.lifeStatusOnPenultimateGeneration = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
  }
  ...
  setLifeStatus(value) {
    if (value === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL || value === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL) {
  ...
  toggleLifeStatus() {
    this.lifeStatus = (this.lifeStatus === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL)
      ? __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL : __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_cell__ = __webpack_require__(4);
...
class Field {
  constructor() {
    this.xSizeOfField = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].MIN_SIZE_OF_FIELD;
    this.ySizeOfField = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].MIN_SIZE_OF_FIELD;
    this.numberOfGeneraton = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].INITIAL_NUMBER_OF_GENERATION;
    this.gameOver = false;
    this.gameStatus = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_IS_RUNNING;
    this.sumOfAllCells = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].DEFAULT_SUM_OF_ALL_CELLS;
  }
  ...
  setXSizeOfField(value) {
    if (value >= __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].MIN_SIZE_OF_FIELD) {
  ...
  setNumberOfGeneration(value) {
    if (value >= __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].INITIAL_NUMBER_OF_GENERATION) {
  ...
  setGameStatus(value) {
    switch (value) {
      case __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_IS_RUNNING:
      case __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_STOPPED_BY_DEAD_UNIVERSE:
      case __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_2_LATEST_GENERATIONS:
      case __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_LAST_AND_PENULTIMATE_GENERATION:
        this.gameStatus = value;
        break;
      default: this.gameStatus = __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].GAME_IS_RUNNING;
        break;
    }
  }
  ...
  setSumOfAllCells(value) {
    if (value >= __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].DEFAULT_SUM_OF_ALL_CELLS) {
  ...
  createRandomField() {
    ...
    this.field.forEach((row, i) => {
      ...
      this.field[i].forEach((column, j) => {
        this.field[i][j] = new __WEBPACK_IMPORTED_MODULE_0__model_cell__["a" /* default */]();
    ...
    if (this.field) {
      ...
      this.field.forEach((row, i) => {
        for (let j = oldXSize; j < this.xSizeOfField; j += 1) {
          this.field[i].push(new __WEBPACK_IMPORTED_MODULE_0__model_cell__["a" /* default */]());
        }
      });
    }
  }
  ...
  toggleCellLifeStatus(i, j) {
    ...
    if (this.field[i][j].getLifeStatus() === __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].ALIVE_CELL) {
...
class FieldChanger {
  calculateField(field) {
    ...
    field.field.forEach((row, i) => {
      this.recountedField[i] = Array(field.getXSizeOfField()).fill(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL);
      row.forEach((column, j) => {
        this._countAliveNeighbors(i, j, field);

        if (field.readCellLifeStatus(i, j) === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL
          && this.amountOfNeighborsStatuses === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_SUM_OF_ALIVE_NEIGHBOURS) {
          this.recountedField[i][j] = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL;
        } else if (field.readCellLifeStatus(i, j) === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL
            && (this.amountOfNeighborsStatuses === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_SUM_OF_ALIVE_NEIGHBOURS
              || this.amountOfNeighborsStatuses === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MAX_SUM_OF_ALIVE_NEIGHBOURS)) {
          this.recountedField[i][j] = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL;
        } else if (field.readCellLifeStatus(i, j) === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL
            && (this.amountOfNeighborsStatuses < __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_SUM_OF_ALIVE_NEIGHBOURS
              || this.amountOfNeighborsStatuses > __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MAX_SUM_OF_ALIVE_NEIGHBOURS)) {
          this.recountedField[i][j] = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
        }
      });
    });
    ...
    field.field.forEach((row, i) => {
      row.forEach((column, j) => {
        ...
        if (previousCellLifeStatus === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL
          && field.readCellLifeStatus(i, j) === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL) {
          field.setSumOfAllCells(field.getSumOfAllCells() - 1);
        }
        if (previousCellLifeStatus === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL
          && field.readCellLifeStatus(i, j) === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL) {
          field.setSumOfAllCells(field.getSumOfAllCells() + 1);
        }
      });
    });
  ...
  _countAliveNeighbors(i, j, field) {
    this.amountOfNeighborsStatuses = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_AMOUNT_OF_ALIVE_NEIGHBOURS;
  ...
  _stopGame(field) {
    this.sameCellsOfFirstAndLastGeneration = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEFAULT_SUM_OF_SAME_CELLS;
    this.sameCellsOfFirstAndPenultimateGeneration = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEFAULT_SUM_OF_SAME_CELLS;
    ...
    if (field.getSumOfAllCells() === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEFAULT_SUM_OF_SAME_CELLS) {
      field.setGameStatus(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].GAME_STOPPED_BY_DEAD_UNIVERSE);
      field.setGameOver(true);
    } else if (this.sameCellsOfFirstAndPenultimateGeneration === field.getXSizeOfField()
                * field.getYSizeOfField()) {
      field.setGameStatus(
        __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_LAST_AND_PENULTIMATE_GENERATION,
      );
      field.setGameOver(true);
    } else if (this.sameCellsOfFirstAndLastGeneration === field.getXSizeOfField()
                * field.getYSizeOfField()) {
      field.setGameStatus(
        __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_2_LATEST_GENERATIONS,
      );
      field.setGameOver(true);
    } else {
      field.setGameStatus(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].GAME_IS_RUNNING);
      field.setGameOver(false);
    }
  }
}

/* harmony default export */ __webpack_exports__["a"] = (FieldChanger);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__blocks_popup_message_popup_message__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants__ = __webpack_require__(0);




class View extends __WEBPACK_IMPORTED_MODULE_0__observer__["a" /* default */] {
  constructor() {
    super();
  ...
  _createView(field, gameStatus, numberOfGeneration) {
    ...
    field.forEach((row, i) => {
      ...
      row.forEach((column, j) => {
        ...
        if (column.getLifeStatus() === __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].DEAD_CELL) {
          td.setAttribute('class', 'field__cell field__cell_dead js-field__cell js-field__cell_dead');
        } else if (column.getLifeStatus() === __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].ALIVE_CELL) {
    ...
    const popupMessage = new __WEBPACK_IMPORTED_MODULE_1__blocks_popup_message_popup_message__["a" /* default */]();

    switch (gameStatus) {
      case __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].GAME_STOPPED_BY_DEAD_UNIVERSE:
        popupMessage.message('Игра закончена, так как во вселенной не осталось жизни!');
        break;
      case __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_2_LATEST_GENERATIONS:
        popupMessage.message('Игра закончена, так как во вселенной сложились устойчивые комбинации на 2-х последних поколениях!');
        break;
      case __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].GAME_STOPPED_BY_STABLE_COMBINATION_ON_LAST_AND_PENULTIMATE_GENERATION:
...
class Controller extends __WEBPACK_IMPORTED_MODULE_0__observer__["a" /* default */] {
  constructor() {
    super();
  ...
  _startTimer(speed) {
    ...
    this.timerId = setInterval(this._actionOnTimer.bind(this),
      (__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].MAX_SPEED - speed) * __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].STEP_OF_DELAY);
...
requireAllFiles(__webpack_require__(19));
...
var map = {
	"./blocks/field/field.styl": 20,
	"./blocks/popup-message/popup-message.styl": 21,
	"./blocks/slider-with-pop-up/slider-with-pop-up.styl": 22,
	"./blocks/standard-button/standard-button.styl": 23,
	"./blocks/wrap/wrap.styl": 24,
	"./index.styl": 25,
	"./vendors/jquery-ui-1.12.1.custom/jquery-ui-forFlatUI.css": 26
};
...
/* WEBPACK VAR INJECTION */(function($) {class SliderWithPopUp {
  constructor($element) {
    this.$element = $element;
    this.initSlider();
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_facade__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controller__ = __webpack_require__(10);
...
class Application {
  constructor() {
    this._model = new __WEBPACK_IMPORTED_MODULE_0__model_facade__["a" /* default */]();
    this._view = new __WEBPACK_IMPORTED_MODULE_1__view__["a" /* default */]();
    this._controller = new __WEBPACK_IMPORTED_MODULE_2__controller__["a" /* default */]();
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_model_field__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__model_model_field_changer__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__observer__ = __webpack_require__(2);
...
class FacadeOfModel extends __WEBPACK_IMPORTED_MODULE_2__observer__["a" /* default */] {
  constructor() {
    super();
    this._field = new __WEBPACK_IMPORTED_MODULE_0__model_model_field__["a" /* default */]();
    this._fieldChanger = new __WEBPACK_IMPORTED_MODULE_1__model_model_field_changer__["a" /* default */]();
  }
  ...
  _toggleCellStatus(row, column) {
    ...
    this._field.setGameStatus(__WEBPACK_IMPORTED_MODULE_3__constants__["a" /* default */].GAME_IS_RUNNING);
...
/* harmony default export */ __webpack_exports__["a"] = (FacadeOfModel);
