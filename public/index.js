...
class Field {
  ...
  createRandomField() {
    ...
    this.fieldMatrix.forEach((row, i) => {
      ...
      this.fieldMatrix[i].forEach((cell, j) => {
        this.fieldMatrix[i][j] = new __WEBPACK_IMPORTED_MODULE_0__model_cell__["a" /* default */]();
  ...
  clearField() {
    ...
    this.fieldMatrix.forEach((row, i) => {
      this.fieldMatrix[i].forEach((cell, j) => {
        this.fieldMatrix[i][j].setLifeStatus(__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].DEAD_CELL);
      });
    });
  }
  ...
  enlargeFieldOnXaxis(xSize) {
    ...
    this.fieldMatrix.forEach((row, i) => {
      for (let j = oldXSize; j < this.xSizeOfField; j += 1) {
        this.fieldMatrix[i].push(new __WEBPACK_IMPORTED_MODULE_0__model_cell__["a" /* default */]());
      }
    });
  }
...
class FieldChanger {
  ...
  _calculateField(field) {
    const recountedField = field.fieldMatrix.map((row, i) => row.map((cell, j) => {
      ...
      let recountedCellLifeStatus = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL;
      const conditionForRevive = cellLifeStatus === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL
        && aliveNeighbors === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_SUM_OF_ALIVE_NEIGHBOURS;
      const conditionForDie = cellLifeStatus === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL
        && (aliveNeighbors === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MIN_SUM_OF_ALIVE_NEIGHBOURS
        || aliveNeighbors === __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MAX_SUM_OF_ALIVE_NEIGHBOURS);

      if (conditionForRevive) {
        recountedCellLifeStatus = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].ALIVE_CELL;
  ...
  _addOnceFieldToHistory(field) {
    ...
    field.fieldMatrix.forEach((row, i) => {
      transformedField[i] = Array(field.getXSizeOfField()).fill(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DEAD_CELL);
      row.forEach((cell, j) => {
  ...
  _createView(fieldMatrix, gameOver, numberOfGeneration) {
    ...
    fieldMatrix.forEach((row, i) => {
      ...
      row.forEach((cell, j) => {
        ...
        const cellBlockClass = cell.getLifeStatus() === __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* default */].DEAD_CELL
